				...
				<table class="table" style="margin-bottom:0px">
					...
					<!-- <tr>
 					...
 					<tr>
 						<td style="width:15%" align="right">金額</td>
 						<td style="width:30%">
 							<input class="form-control"  placeholder="多少錢ex:30000" id="new_pay_rent_value" required="required" style="width:100%" type="text"  >
 						</td>
 					...
 					<tr>
 						...
 						<td style="width:30%">
 							<input class="form-control" placeholder="匯款人的姓名或帳號ex:王大名, 93289048" id="new_pay_rent_from" required="required" style="width:100%" type="text"  >
 						</td>
 					...
 					<tr>
 						<td style="width:15%" align="right">新增日期</td>
 						<td style="width:30%">
 							<input class="form-control" placeholder="款項在郵局/銀行入帳日期" id="new_pay_rent_date" required="required" style="width:100%" type="text"  >
 						</td>
 					...
 					<tr>
 						<td style="width:15%"  align="right">描述或備註</td>
 						<td colspan="3">
 							<textarea class="form-control" placeholder="其他備註," onchange="change_alert()" id="new_pay_rent_description" style="resize: none;"  style="width:100%"  rows="2"></textarea>
 						</td>
 					</tr>
 				</table>
